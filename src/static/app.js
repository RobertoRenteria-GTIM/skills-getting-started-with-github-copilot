              ...
              ${details.participants.map(participant => `
                <li class="participant-item">
                  ...
                  <button class="delete-participant" title="Remove participant" data-activity="${name}" data-email="${participant}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 20 20" fill="none"><circle cx="10" cy="10" r="10" fill="#ffebee"/><path d="M7 7l6 6M13 7l-6 6" stroke="#c62828" stroke-width="2" stroke-linecap="round"/></svg>
                  </button>
                </li>
              `).join('')}
            </ul>
